...
{{
    "category": "分类名称",
    "reason": "分类原因说明",
    "reference": "一级分类-二级指标-具体问题类型"
}}

# reference字段格式说明
必须按照"数字.一级分类-数字.数字 二级指标-具体问题类型"的格式，例如：
- "2.信息清晰性-2.2.2 功能入口易见-功能/信息入口隐蔽"
- "4.系统可靠性-4.2.2 系统运行稳定-功能无法正常使用"
- "5.一致性-5.2.1 信息传达一致-前后端信息不一致"
- "3.任务高效性-3.2.1 任务步骤合理-任务步骤或操作路径复杂冗余"
